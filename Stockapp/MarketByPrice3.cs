...
namespace Stock_app
{
    public partial class MarketByPrice3 : Form, StockMarketDisplay
    {
        public MarketByPrice3()
        {
            InitializeComponent();
        ...
        public void Update(StockMarket data)
        {
            ...
            SellOrder[] sellorderz = stock.companies[2].sellorders;
            BuyOrder[] buyorderz = stock.companies[2].buyorders;

            int secret = 0;
            if (stock.companies[2].lastOrder.Equals("BuyOrder"))
            {

                BuyOrder mybuy = stock.companies[2].getLastBuyOrder();
            ...
            {
                secret = 0;
                SellOrder mysell = stock.companies[2].getLastSellOrder();
                for (int k = 0; k < dataGridView1.Rows.Count; ++k)
                {
        ...
        private void MarketByPrice3_Load(object sender, EventArgs e)
        {
