...
namespace Stock_app
{
    public partial class MarketByPrice2 : Form, StockMarketDisplay
    {
        public MarketByPrice2()
        {
            InitializeComponent();
            dataGridView1.Rows.Add(10);
        }
        string identity = "AppleP";
        int bidNumber;
        ...
        private void MarketByPrice2_Load(object sender, EventArgs e)
        {
