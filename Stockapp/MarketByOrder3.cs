...
namespace Stock_app
{
    public partial class MarketByOrder3 : Form, StockMarketDisplay
    {
        public MarketByOrder3()
        {
            InitializeComponent();
        ...
        public void Update(StockMarket data)
        {
            ...
            //stock.companies[2].orderSells();
            //stock.companies[2].orderBuys();
        ...
        private void MarketByOrder3_Load(object sender, EventArgs e)
        {
